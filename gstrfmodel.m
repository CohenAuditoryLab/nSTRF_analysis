...
% SHANNON: INDEX EXCEEDS MATRIX DIMENSION ERROR HERE, commenting out bc
% % don't need for calculating alpha_d (separability index)

% %Energy Error Metric
% j=find(STRF~=0);
% % assignin('base', 'j', j);
% % assignin('base', 'STRFm', STRFm);
% % assignin('base', 'STRF', STRF);
