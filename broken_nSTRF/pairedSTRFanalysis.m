...
% pairedSTRFanalysis('/Users/shannon1/Documents/F19/neuroResearch/broken_nSTRF/spike_times_ripple_clust_old.mat', 1, 2, 500, '/Users/shannon1/Documents/F19/neuroResearch/broken_nSTRF/DNR_Cortex_96k5min_4_50.spr','/Users/shannon1/Documents/F19/neuroResearch/broken_nSTRF/AudiResp_16_24-190326-154559_triggers.mat', 'old')

% spike_clusters='/Users/shannon1/Documents/F19/neuroResearch/Cassius-190326/spike_times_ripple_clust.mat'
% sprfile='/Users/shannon1/Documents/F19/neuroResearch/Moving_ripple/DMR_50HZ/DNR_Cortex_96k5min_4_50.spr'
...
function [clusOneSTRF,clusTwoSTRF,nSTRF,orSTRF,andSTRF,nCorrOr,nCorrAnd] = pairedSTRFanalysis(spike_clusters,cluster1,cluster2,time_window,sprfile,Trig,version)
    ...
    try
        ...
        disp('Error when computing nSTRF1A, exiting function')
        disp(me);
        return;
    end
    ...
    try
        ...
        disp('Error when computing nSTRF1B, exiting function')
        disp(me);
        return;
    end
