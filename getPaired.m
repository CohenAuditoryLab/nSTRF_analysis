% function getPaired(sprfile,Trig)
%
%   FILE NAME   : getPaired.m
%   DESCRIPTION : This file saves pairwise analysis data to a 
%       pairedData struct database (assumes individual STRF data saved in
%       clusData struct to workspace)
%       
%
% INPUT PARAMS
...
%                       spikeClusters
%   indices         : full path to indices.mat containing clusData
%                       (see collectParams to obtain clusData)
%
% RETURNED VARIABLES
%   N/A
%
% Tested function as follows:
% getPaired('/Users/shannon1/Documents/F19/neuroResearch/nSTRF/spike_times_ripple_clust_new.mat', '/Users/shannon1/Documents/F19/neuroResearch/nSTRF/DNR_Cortex_96k5min_4_50.spr','/Users/shannon1/Documents/F19/neuroResearch/nSTRF/AudiResp_16_24-190326-154559_triggers.mat', 'st_clu', '/Users/shannon1/Documents/F19/neuroResearch/nSTRF/indices.mat')

function getPaired(spikeClusters,sprfile,Trig,version, indices)
    ...
    allIndices = load(indices);
    clusData = allIndices.clusData;
