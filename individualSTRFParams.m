% function [clusData] = individualSTRFParams(Params, spikeTimeRipClus,sprfile,Trig,numClusters)
%
%   FILE NAME   : individualSTRFParams.m
...
function [clusData] = individualSTRFParams(Params,spikeTimeRipClus,sprfile,Trig,numClusters)
    ...
    for i=1:numClusters
        ...
        try
            ...
            disp(['Error when computing STRF1/STRF2 of cluster ' num2str(spikeTimeRipClus{i, 1}) ', exiting function'])
            disp(me);
            return;
        end
        ...
        % can later add strfgaborfit.m (need to modify lsqcurvefit to use
        % patternsearch instead
